...
<head>
	...
	<title>GoM6在线代理 WEB代理服务器程序的介绍和架设</title>
...
<p>现再主流的代理程序有Surrogafier, CGIproxy,PHPProxy BBlocked、Glype和Zelune，那么这些程是都是用不同的语言编写出来的，在架设代理服务器前，对你所选的代理程序，它的服务器环境要求了解清楚，这样才能跟所要求购买空间或自己架设服务器。
我个人建议使用PHPProxy或Glype，这两个都是PHP语言所写，在安装的时候也非常简单，是我见过使用最多的两个代理程序。
下面我们就详细的介绍一下功能与架设调式方法。
</p>
</div>
